...
import { Comment, ObjectProperty, StringLiteral, TSCallSignatureDeclaration } from '@babel/types'
 ...
 */
export const parseComments = (node: ObjectProperty | StringLiteral | TSCallSignatureDeclaration) => {
